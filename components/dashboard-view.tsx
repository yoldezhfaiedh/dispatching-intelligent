...
export function DashboardView() {
  ...
  const cards = [
    ...
    { label: 'Actions urgentes', value: `${value(kpis?.high_priority_recommendations)} / ${value(kpis?.total_recommendations)}`, icon: TrendingDown, caption: 'Recommandations high' },
    { label: 'Unités à dispatcher', value: value(kpis?.total_units_to_dispatch), icon: Warehouse, caption: 'Besoin réseau estimé' },
  ]
